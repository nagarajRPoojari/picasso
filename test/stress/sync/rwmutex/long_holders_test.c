...
void short_reader(__public__rwmutex_t* mu) {
...
void short_writer(__public__rwmutex_t* mu) {
...
void long_writer(__public__rwmutex_t* mu) {
    __public__sync_rwmutex_rwlock(mu);
    atomic_fetch_add(&writers_in, 1);
...
void test_rwmutex_concurrent_long_holders(void) {
...
int main(void) {
    ...
    RUN_TEST(test_rwmutex_concurrent_long_holders);
    return UNITY_END();
}