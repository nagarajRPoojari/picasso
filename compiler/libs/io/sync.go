...
func (t *SyncIO) printf(typeHandler *typedef.TypeHandler, module *ir.Module, bh *bc.BlockHolder, args []typedef.Var) typedef.Var {
	printfFn := c.NewInterface(module).Funcs[c.PRINTF]
	return libutils.CallCFunc(typeHandler, printfFn, bh, args)
}

func (t *SyncIO) scanf(typeHandler *typedef.TypeHandler, module *ir.Module, bh *bc.BlockHolder, args []typedef.Var) typedef.Var {
...
func (t *SyncIO) fprintf(typeHandler *typedef.TypeHandler, module *ir.Module, bh *bc.BlockHolder, args []typedef.Var) typedef.Var {
	fprintfFn := c.NewInterface(module).Funcs[c.FPRINTF]
	return libutils.CallCFunc(typeHandler, fprintfFn, bh, args)
}

func (t *SyncIO) fscanf(typeHandler *typedef.TypeHandler, module *ir.Module, bh *bc.BlockHolder, args []typedef.Var) typedef.Var {
...
func (t *SyncIO) fputs(typeHandler *typedef.TypeHandler, module *ir.Module, bh *bc.BlockHolder, args []typedef.Var) typedef.Var {
	fputsFunc := c.NewInterface(module).Funcs[c.FPUTS]
	return libutils.CallCFunc(typeHandler, fputsFunc, bh, args)
}

func (t *SyncIO) fgets(typeHandler *typedef.TypeHandler, module *ir.Module, bh *bc.BlockHolder, args []typedef.Var) typedef.Var {
